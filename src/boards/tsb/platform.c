 ...
 * Toggle LED 0
 *****************************************************************************/
void PLATFORM_ToggleLed0() {
        GPIO_PinOutToggle(PLATFORM_LED0_PORT, PLATFORM_LED0_PIN);
}

/******************************************************************************
 * Toggle LED 1
 *****************************************************************************/
void PLATFORM_ToggleLed1() {
        GPIO_PinOutToggle(PLATFORM_LED1_PORT, PLATFORM_LED1_PIN);
}

/******************************************************************************
 * Toggle LED 2 
 *****************************************************************************/
void PLATFORM_ToggleLed2() {
        GPIO_PinOutToggle(PLATFORM_LED2_PORT, PLATFORM_LED2_PIN);
}
